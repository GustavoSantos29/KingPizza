...
const MOCK_PIZZAS: ProductProps[] = [
  {
    ...
    description:
      "Massa artesanal, molho de tomate italiano, muita calabresa fatiada e cebola roxa.",
    price: "R$ 45,00",
  },
  {
    id: "2",
    ...
    description:
      "Mussarela, provolone, parmesão e gorgonzola derretidos sobre massa fina.",
    price: "R$ 52,00",
  },
  {
    id: "3",
    ...
    description:
      "Frango desfiado temperado coberto com o autêntico catupiry original.",
    price: "R$ 48,00",
  },
  {
    id: "4",
...
export function Menu() {
  ...
  const paddingTop =
    Platform.OS === "android" ? RNStatusBar.currentHeight! + 10 : 0;
